...
class TicketTypeSelect(discord.ui.View):
  ...
  @discord.ui.select(placeholder="Выберите нужное", custom_id="ticket:placing_an_order", options=[discord.SelectOption(label="Рендер", value="render", emoji="<:Netherite_Upgrade_Smithing_Templ:1495122438797660243>"), discord.SelectOption(label="Анимация", value="animation", emoji="<:Axolotl:1503669257286717440>", default=False)])
